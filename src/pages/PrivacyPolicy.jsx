      ...
      <div class="flex-1 ">
        <div class="relative">
          ...
          <img
            src="/images/11.jpg"
            alt=""
            className="md:h-full md:w-full sm:h-[0vh] object-cover opacity-90"
          />
          {/* // <img alt="BG Privacy Terms Banner Image" loading="lazy" decoding="async" data-nimg="fill" class="xl:rounded-lg" sizes="100vw" src="/images/11.jpg" className="h-full  w-full position: absolute; inset: 0px; object-fit: cover; object-position: center center; color: transparent;"/> */}

          {/* <div class="absolute top-[12%] md:top-[8%] left-[50%] translate-x-[-50%] translate-y-[-50%] px-8 py-36 overflow-hidden">
                <h1 class="text-shadow t-shadow text-center text-xl font-semibold font-serif text-[#bf7c49] md:text-5xl">Privacy Policy</h1>
            </div> */}
        </div>

        <div class="mx-auto max-w-5xl px-4 py-8 font-serif font-inter sm:px-6">
          <div class="prose prose-lg mx-auto p-4">
            <p class="mb-4">
            ...
            <h2 class="mb-4 text-xl font-bold">Interpretation</h2>
            <p class="mb-4">
            ...
            <h2 class="mb-4 text-xl font-bold">Definitions</h2>
            ...
            <ul class="mb-4 ml-8 list-disc">
              ...
              <li>
                <p>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to Ved Vyas
                  Foundation, C-604 IRWO Sector 47 Gurugram Gurgaon HR 122018
                  INDIA.
                </p>
              </li>
            ...
            <h2 class="mb-4 text-xl font-bold">Types of Data Collected</h2>
            <h3 class="mb-4 text-lg font-bold">Personal Data</h3>
            <p class="mb-4">
            ...
            <h3 class="mb-4 text-lg font-bold">Usage Data</h3>
            <p class="mb-4">
            ...
            <h2 class="mb-4 text-xl font-bold">Use of Your Personal Data</h2>
            <p class="mb-4">
            ...
            <h2 class="mb-4 text-xl font-bold">Delete Your Personal Data</h2>
            <p class="mb-4">
            ...
            <h3 class="mb-4 text-lg font-bold">Business Transactions</h3>
            <p class="mb-4">
            ...
            <h3 class="mb-4 text-lg font-bold">Law enforcement</h3>
            <p class="mb-4">
            ...
            <h3 class="mb-4 text-lg font-bold">Other legal requirements</h3>
            <p class="mb-4">
            ...
            <h1 class="mb-4 text-2xl font-bold">Children's Privacy</h1>
            <p class="mb-4">
            ...
            <h1 class="mb-4 text-2xl font-bold">Links to Other Websites</h1>
            <p class="mb-4">
